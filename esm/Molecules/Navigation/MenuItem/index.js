...
import PropTypes from 'tprop-types';
import React, { Component } from 'react';
import styled from 'styled-components';
var Item = styled.li(_templateObject, function (props) {
...
function (_Component) {
  ...
  _createClass(MenuItem, [{
    ...
    value: function render() {
      ...
      return flexibleSpace ? React.createElement(Item, {
        style: {
          flexGrow: 1
        }
