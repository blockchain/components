...
var _weights = _interopRequireDefault(require("@ibm/plex/scripts/data/weights"));
...
var variants = _weights.default.filter(function (_ref) {
...
(0, _styledComponents.injectGlobal)(_templateObject(), fonts);