...
storiesOf('Atoms/Typography/TextGroup', module)
  .add('default', () => <TextGroup><Texts /></TextGroup>)
  .add('with align', () => <TextGroup align='right'><Texts /></TextGroup>)
  .add('with inline', () => <TextGroup inline={false}><Texts /></TextGroup>)
  .add('with align and inline', () => <TextGroup align='right' inline={false}><Texts /></TextGroup>)
